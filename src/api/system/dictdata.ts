...
// 查询字典数据列表
export async function getDictDataList(params?: API.System.DictDataListParams, options?: { [key: string]: any }) {
...
// 导出字典数据
export function exportDictData(params?: API.System.DictDataListParams, options?: { [key: string]: any }) {
	return request<API.Result>({
