 ...
 */
/** 发送验证码 POST /api/code*/
export const getCaptchaImg = (params?: Record<string, any>, options?: Record<string, any>) => {
...
export const getMenuList = () => {
	return http.get<Menu.MenuOptions[]>(`/system/menu/menuList`);
};
