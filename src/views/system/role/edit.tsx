...
const RoleForm: React.FC<RoleFormProps> = props => {
	...
	return (
		<Modal width={640} title="编辑角色信息" forceRender open={props.open} destroyOnClose onOk={handleOk} onCancel={handleCancel}>
			<ProForm form={form} grid={true} layout="horizontal" submitter={false} onFinish={handleFinish}>
				<ProFormDigit
					name="roleId"
					label="角色编号"
					placeholder="请输入角色编号"
