		...
		<PageContainer>
			...
			<UpdateForm
				onSubmit={async values => {
					if (values && values.password) values.password = md5(values.password);
			...
			<ResetPwd
				onSubmit={async (values: any) => {
					const resetPassword = md5(values.password);
					const success = await resetUserPwd(values.userId, resetPassword);
					if (success) {
