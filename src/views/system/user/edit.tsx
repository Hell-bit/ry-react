...
const UserForm: React.FC<UserFormProps> = props => {
	...
	return (
		<Modal width={640} title="编辑用户信息" open={props.open} destroyOnClose onOk={handleOk} onCancel={handleCancel}>
			<ProForm grid={true} form={form} layout="horizontal" submitter={false} onFinish={handleFinish}>
				<ProFormText name="userId" label="用户Id" hidden={true} />
				<ProFormText
					name="nickName"
					label="用户昵称"
					placeholder="请输入用户昵称"
