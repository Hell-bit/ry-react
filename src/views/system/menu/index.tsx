...
import { getMenutoList, removeMenu, addMenu, updateMenu, exportMenu } from "@/api/system/menu";
		...
		<PageContainer>
			<div style={{ width: "100%", float: "right" }}>
				<ProTable<API.System.Menu>
					...
					request={params =>
						getMenutoList({ ...params } as API.System.MenuListParams).then(res => {
